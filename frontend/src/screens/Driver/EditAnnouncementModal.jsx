...
const EditAnnouncementModal = ({ id, onClose, startPoint, wayPoints, destination, maxDimensions, packagesTypes, availableCapacity , startDate }) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { setSubmitting }) => {
      try {
        await axios.put(
          `http://localhost:7460/api/announcements/update/${id}`,
          values,{
